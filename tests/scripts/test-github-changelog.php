...
define( 'CHANGELOG_TITLE_FORMAT', '{repo} {datetime}' );
...
<li>Fixed another bug</li>
		...
		$this->assertEquals( 'test-project ' . gmdate( 'Y-m-d H:i' ), $parsed['title'] );
		$this->assertEquals(
			'<h3>Fixed</h3>
<ul>
<li>Fixed a bug</li>
...
<li>Added a <code>feature</code></li>
	...
	public function test_generate_changelog_title_with_default_format(): void {
		...
		$this->assertEquals( 'test-project ' . gmdate( 'Y-m-d H:i' ), $title );
	}
